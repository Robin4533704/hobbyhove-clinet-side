...
const handleImageUpload = async (e) => {
  ...
  <h1 className="text-2xl font-bold mb-4 text-center text-black dark:text-gray-800">Create Account</h1>
  ...
  <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
    ...
    <input
      ...
      className={`input input-bordered w-full rounded-lg transition-all duration-300 placeholder-gray-500 dark:placeholder-gray-600 text-black dark:text-gray-800 ${
    ...
    <div className="relative">
      <input
        ...
        className={`input input-bordered w-full pr-10 rounded-lg transition-all duration-300 placeholder-gray-500 dark:placeholder-gray-600 text-black dark:text-gray-800 ${
          errors.password ? "border-red-500" : "border-gray-300 focus:border-lime-500 focus:ring focus:ring-lime-200"
        }`}
      />
      <button
        type="button"
        className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-700 dark:text-gray-600 hover:text-gray-800 dark:hover:text-gray-700"
  ...
  <p className="mt-2 text-black dark:text-gray-800">
    Already have an account? <Link to="/auth/login" className="text-blue-500 dark:text-blue-400">Login</Link>
  </p>
